...
struct struct_CO_Data {
	/* Object dictionary */
	UNS8 *bDeviceNodeId;//设备ID号
	const indextable *objdict;//subindex
	s_PDO_status *PDO_status;//PDO状态
	TIMER_HANDLE *RxPDO_EventTimers;//RXPDO 触发时间
	void (*RxPDO_EventTimers_Handler)(CO_Data*, UNS32);//RxPDO_EventTimers处理程序
	const quick_index *firstIndex; //开始快速 INDEX
	const quick_index *lastIndex;//结束 快速 INDEX
	const UNS16 *ObjdictSize;//对象字典 大小
